...
class Database:
    ...
    def save_products(self, products: List[Dict[str, Any]], table_name: str = "blinkit_products"):
        """
    ...
    def fetch_products(self, table_name: str = "blinkit_products", limit: int = 1000):
        if not self.client:
            return []
