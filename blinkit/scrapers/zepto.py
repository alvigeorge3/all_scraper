...
class ZeptoScraper(BaseScraper):
    ...
    async def scrape_availability(self, product_url: str) -> AvailabilityResult:
        ...
        result: AvailabilityResult = {
            ...
            "platform": "zepto",
            "name": "N/A",
            "price": None,  # Changed from 0.0 to prevent NaN
            "mrp": None,    # Changed from 0.0 to prevent NaN
        ...
        try:
            ...
            try:
                ...
                logger.info(f"JSON extraction successful: name={result['name']}, price={result['price']}, mrp={result['mrp']}")
